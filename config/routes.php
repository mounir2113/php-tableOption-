...
$route['getdelivarylocation'] = "Hungry/getdelivarylocation";
$route['posorderinvoice/(:any)'] = "Hungry/posorderinvoice";
...
$route['api/get-current-order'] = "Hungry/get_current_order";
